    ...
    updateAt_: function (n, isAt) {
        ...
        if (isAt) {
            ...
            if (Msg['ORDINAL_NUMBER_SUFFIX']) {
                this.appendDummyInput('ORDINAL' + n).appendField(Msg['ORDINAL_NUMBER_SUFFIX']);
            }
        }
        else {
...
Extensions.register('text_append_tooltip', Extensions.buildTooltipWithFieldText('%{BKY_TEXT_APPEND_TOOLTIP}', 'VAR'));
/**
 * Update the tooltip of 'text_append' block to reference the variable.
 */
const INDEXOF_TOOLTIP_EXTENSION = function () {
    this.setTooltip(() => {
        return Msg['TEXT_INDEXOF_TOOLTIP'].replace('%1', this.workspace.options.oneBasedIndex ? '0' : '-1');
    });
};
/**
...
const CHARAT_MUTATOR_MIXIN = {
    ...
    updateAt_: function (isAt) {
        ...
        if (isAt) {
            ...
            if (Msg['ORDINAL_NUMBER_SUFFIX']) {
                this.appendDummyInput('ORDINAL').appendField(Msg['ORDINAL_NUMBER_SUFFIX']);
            }
        }
...
Extensions.registerMutator('text_join_mutator', JOIN_MUTATOR_MIXIN, JOIN_EXTENSION);
Extensions.registerMutator('text_charAt_mutator', CHARAT_MUTATOR_MIXIN, CHARAT_EXTENSION);
