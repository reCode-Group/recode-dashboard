...
(function (Order) {
    ...
    Order[Order["UNARY_POSTFIX"] = 1] = "UNARY_POSTFIX";
    Order[Order["UNARY_PREFIX"] = 2] = "UNARY_PREFIX";
    Order[Order["MULTIPLICATIVE"] = 3] = "MULTIPLICATIVE";
    Order[Order["ADDITIVE"] = 4] = "ADDITIVE";
    Order[Order["SHIFT"] = 5] = "SHIFT";
    Order[Order["BITWISE_AND"] = 6] = "BITWISE_AND";
    Order[Order["BITWISE_XOR"] = 7] = "BITWISE_XOR";
    Order[Order["BITWISE_OR"] = 8] = "BITWISE_OR";
    Order[Order["RELATIONAL"] = 9] = "RELATIONAL";
    Order[Order["EQUALITY"] = 10] = "EQUALITY";
    Order[Order["LOGICAL_AND"] = 11] = "LOGICAL_AND";
    Order[Order["LOGICAL_OR"] = 12] = "LOGICAL_OR";
    Order[Order["IF_NULL"] = 13] = "IF_NULL";
    Order[Order["CONDITIONAL"] = 14] = "CONDITIONAL";
    Order[Order["CASCADE"] = 15] = "CASCADE";
...
//# sourceMappingURL=dart_generator.js.map