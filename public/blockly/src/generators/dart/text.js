...
export function text_join(block, generator) {
    ...
    switch (joinBlock.itemCount_) {
        case 0:
            return ["''", Order.ATOMIC];
        case 1: {
            const element = generator.valueToCode(block, 'ADD0', Order.UNARY_POSTFIX) || "''";
...
export function text_length(block, generator) {
    ...
    const text = generator.valueToCode(block, 'VALUE', Order.UNARY_POSTFIX) || "''";
...
export function text_trim(block, generator) {
    ...
    const text = generator.valueToCode(block, 'TEXT', Order.UNARY_POSTFIX) || "''";
