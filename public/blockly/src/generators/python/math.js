...
export function math_constant(block, generator) {
    ...
    if (constant !== 'INFINITY') {
        generator.definitions_['import_math'] =
            'import math';
    }
...
export function math_number_property(block, generator) {
    ...
    const numberToCheck = generator.valueToCode(block, 'NUMBER_TO_CHECK', inputOrder) || '0';
    let code;
...
`);
        ...
        const divisor = generator.valueToCode(block, 'DIVISOR', Order.MULTIPLICATIVE) || '0';
...
`);
        ...
        case 'STD_DEV': {
            generator.definitions_['import_math'] =
                'import math';
            const functionName = generator.provideFunction_('math_standard_deviation', `
...
export function math_modulo(block, generator) {
    ...
    const argument1 = generator.valueToCode(block, 'DIVISOR', Order.MULTIPLICATIVE) || '0';
...
export function math_constrain(block, generator) {
    ...
    const argument2 = generator.valueToCode(block, 'HIGH', Order.NONE) || "float('inf')";
