...
export function controls_if(block, generator) {
    ...
    do {
        ...
        if (generator.STATEMENT_SUFFIX) {
            branchCode =
                generator.prefixLines(generator.injectId(generator.STATEMENT_SUFFIX, block), generator.INDENT) + branchCode;
        }
...
export function logic_negate(block, generator) {
    // Negation.
    const argument0 = generator.valueToCode(block, 'BOOL', Order.LOGICAL_NOT) || 'True';
...
export function logic_ternary(block, generator) {
    ...
    const value_then = generator.valueToCode(block, 'THEN', Order.CONDITIONAL) || 'None';
    const value_else = generator.valueToCode(block, 'ELSE', Order.CONDITIONAL) || 'None';
