...
export function text_join(block, generator) {
    ...
    if (joinBlock.itemCount_ === 0) {
        ...
        const element0 = generator.valueToCode(block, 'ADD0', Order.CONCATENATION) || "''";
        const element1 = generator.valueToCode(block, 'ADD1', Order.CONCATENATION) || "''";
...
export function text_append(block, generator) {
    ...
    const value = generator.valueToCode(block, 'TEXT', Order.CONCATENATION) || "''";
