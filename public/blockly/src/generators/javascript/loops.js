...
export function controls_forEach(block, generator) {
    ...
    if (!argument0.match(/^\w+$/)) {
        listVar = generator.nameDB_.getDistinctName(variable0 + '_list', NameType.VARIABLE);
        code += 'var ' + listVar + ' = ' + argument0 + ';\n';
    }
    const indexVar = generator.nameDB_.getDistinctName(variable0 + '_index', NameType.VARIABLE);
    branch =
        generator.INDENT +
            variable0 +
            ' = ' +
