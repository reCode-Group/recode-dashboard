...
(function (verticalPosition) {
    ...
    verticalPosition[verticalPosition["BOTTOM"] = 1] = "BOTTOM";
 ...
 * @internal
 */
export var bumpDirection;
(function (bumpDirection) {
    bumpDirection[bumpDirection["UP"] = 0] = "UP";
    bumpDirection[bumpDirection["DOWN"] = 1] = "DOWN";
 ...
 * @internal
 */
export function getStartPositionRect(position, size, horizontalPadding, verticalPadding, metrics, workspace) {
    // Horizontal positioning.
    let left = 0;
    const hasVerticalScrollbar = workspace.scrollbar && workspace.scrollbar.canScrollVertically();
...
export function getCornerOppositeToolbox(workspace, metrics) {
    const leftCorner = metrics.toolboxMetrics.position !== toolbox.Position.LEFT &&
...
//# sourceMappingURL=positionable_helpers.js.map