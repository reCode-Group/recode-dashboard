...
export class BlockDelete extends BlockBase {
    ...
    constructor(opt_block) {
        super(opt_block);
        this.type = EventType.BLOCK_DELETE;
        if (!opt_block) {
    ...
    toJson() {
        ...
        if (!this.oldXml) {
            throw new Error('The old block XML is undefined. Either pass a block ' +
        ...
        if (this.wasShadow === undefined) {
            throw new Error('Whether the block was a shadow is undefined. Either ' +
                'pass a block to the constructor, or call fromJson');
        }
        if (!this.oldJson) {
            throw new Error('The old block JSON is undefined. Either pass a block ' +
                'to the constructor, or call fromJson');
        }
    ...
    static fromJson(json, workspace, event) {
        const newEvent = super.fromJson(json, workspace, event ?? new BlockDelete());
...
//# sourceMappingURL=events_block_delete.js.map