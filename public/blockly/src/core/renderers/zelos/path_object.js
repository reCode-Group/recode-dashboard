...
export class PathObject extends BasePathObject {
    ...
    updateSelected(enable) {
        ...
        if (enable) {
            if (!this.svgPathSelected) {
                ...
                dom.removeClass(this.svgPathSelected, FocusManager.ACTIVE_FOCUS_NODE_CSS_CLASS_NAME);
                dom.removeClass(this.svgPathSelected, FocusManager.PASSIVE_FOCUS_NODE_CSS_CLASS_NAME);
    ...
    getOutlinePath(name) {
        if (!this.outlines.has(name)) {
            this.outlines.set(name, dom.createSvgElement(Svg.PATH, {
