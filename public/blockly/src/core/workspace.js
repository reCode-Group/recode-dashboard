...
export class Workspace {
     ...
     */
    getBlocksByType(type, ordered = false) {
    ...
    renameVariableById(id, newName) {
        deprecation.warn('Blockly.Workspace.renameVariableById', 'v12', 'v13', 'Blockly.Workspace.getVariableMap().renameVariable');
    ...
    createVariable(name, opt_type, opt_id) {
        ...
        return this.variableMap.createVariable(name, opt_type ?? undefined, opt_id ?? undefined);
    }
    /**
    ...
    getVariableUsesById(id) {
        deprecation.warn('Blockly.Workspace.getVariableUsesById', 'v12', 'v13', 'Blockly.Workspace.getVariableMap().getVariableUsesById');
    ...
    deleteVariableById(id) {
        deprecation.warn('Blockly.Workspace.deleteVariableById', 'v12', 'v13', 'Blockly.Workspace.getVariableMap().deleteVariable');
        const variable = this.variableMap.getVariableById(id);
        if (!variable) {
    ...
    getVariable(name, opt_type) {
        deprecation.warn('Blockly.Workspace.getVariable', 'v12', 'v13', 'Blockly.Workspace.getVariableMap().getVariable');
     ...
     */
    getVariableById(id) {
        deprecation.warn('Blockly.Workspace.getVariableById', 'v12', 'v13', 'Blockly.Workspace.getVariableMap().getVariableById');
    ...
    getVariablesOfType(type) {
        deprecation.warn('Blockly.Workspace.getVariablesOfType', 'v12', 'v13', 'Blockly.Workspace.getVariableMap().getVariablesOfType');
     ...
     */
    getAllVariables() {
        deprecation.warn('Blockly.Workspace.getAllVariables', 'v12', 'v13', 'Blockly.Workspace.getVariableMap().getAllVariables');
    ...
    getVariableMapClass() {
        const VariableMap = registry.getClassFromOptions(registry.Type.VARIABLE_MAP, this.options, true);
        if (!VariableMap) {
