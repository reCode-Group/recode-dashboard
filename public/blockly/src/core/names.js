...
export class Names {
    ...
    constructor(reservedWordsList, opt_variablePrefix) {
        ...
        this.reservedWords = new Set(reservedWordsList ? reservedWordsList.split(',') : []);
    }
    /**
...
(function (Names) {
    ...
    let NameType;
    (function (NameType) {
        NameType["DEVELOPER_VARIABLE"] = "DEVELOPER_VARIABLE";
        NameType["VARIABLE"] = "VARIABLE";
        NameType["PROCEDURE"] = "PROCEDURE";
    })(NameType = Names.NameType || (Names.NameType = {}));
})(Names || (Names = {}));
