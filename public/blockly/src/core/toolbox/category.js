...
export class ToolboxCategory extends ToolboxItem {
    ...
    createIconDom_() {
        ...
        if (!this.parentToolbox_.isHorizontal()) {
            ...
            if (className) {
                ...
                toolboxIcon.style = "transform: translateY(6px)";
                dom.addClass(toolboxIcon, 'material-symbols-outlined');
            }
        }
    ...
    createLabelDom_(name) {
        ...
        if (className) {
            toolboxLabel.style = "transform: translateY(22px)";
    ...
    setSelected(isSelected) {
        ...
        if (isSelected) {
            const defaultColour = this.parseColour(ToolboxCategory.defaultBackgroundColour);
...
.blocklyToolboxCategory:not(.blocklyToolboxSelected):hover .blocklyToolboxCategoryIcon {
  color: #aaa;
}
...
.blocklyToolboxCategoryLabel, .blocklyToolboxCategoryIcon {
  color: #9ca3af;
}
...
.blocklyToolboxSelected .blocklyToolboxCategoryIcon {
  color: #fff;
}
`);
