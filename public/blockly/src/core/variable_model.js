...
export class VariableModel {
     ...
     */
    static load(state, workspace) {
        const variable = new this(workspace, state['name'], state['type'], state['id']);
        workspace.getVariableMap().addVariable(variable);
        eventUtils.fire(new (eventUtils.get(EventType.VAR_CREATE))(variable));
    }
}
registry.register(registry.Type.VARIABLE_MODEL, registry.DEFAULT, VariableModel);
//# sourceMappingURL=variable_model.js.map