 ...
 */
let afterRendersPromise = null;
/** The function to call to resolve the `afterRendersPromise`. */
let afterRendersResolver = null;
/**
 ...
 * @internal
 */
export function queueRender(block) {
    queueBlock(block);
 ...
 *     been completed.
 */
export function finishQueuedRenders() {
 ...
 * @internal
 */
export function triggerQueuedRenders(workspace) {
    if (!workspace)
        window.cancelAnimationFrame(animationRequestId);
    doRenders(workspace);
    if (!workspace && afterRendersResolver)
        afterRendersResolver();
}
/**
 ...
 */
function shouldRenderRootBlock(block) {
...
//# sourceMappingURL=render_management.js.map