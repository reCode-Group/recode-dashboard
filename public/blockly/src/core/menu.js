...
export class Menu {
    ...
    render(container) {
        ...
        // Add event handlers.
        this.pointerMoveHandler = browserEvents.conditionalBind(element, 'pointermove', this, this.handlePointerMove, true);
        this.clickHandler = browserEvents.conditionalBind(element, 'pointerup', this, this.handleClick, true);
        this.pointerEnterHandler = browserEvents.conditionalBind(element, 'pointerenter', this, this.handlePointerEnter, true);
        this.pointerLeaveHandler = browserEvents.conditionalBind(element, 'pointerleave', this, this.handlePointerLeave, true);
