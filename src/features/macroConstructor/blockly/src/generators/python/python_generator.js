...
(function (Order) {
    ...
    Order[Order["COLLECTION"] = 1] = "COLLECTION";
    Order[Order["STRING_CONVERSION"] = 1] = "STRING_CONVERSION";
    Order[Order["MEMBER"] = 2.1] = "MEMBER";
    Order[Order["FUNCTION_CALL"] = 2.2] = "FUNCTION_CALL";
    Order[Order["EXPONENTIATION"] = 3] = "EXPONENTIATION";
    Order[Order["UNARY_SIGN"] = 4] = "UNARY_SIGN";
    Order[Order["BITWISE_NOT"] = 4] = "BITWISE_NOT";
    Order[Order["MULTIPLICATIVE"] = 5] = "MULTIPLICATIVE";
    Order[Order["ADDITIVE"] = 6] = "ADDITIVE";
    Order[Order["BITWISE_SHIFT"] = 7] = "BITWISE_SHIFT";
    Order[Order["BITWISE_AND"] = 8] = "BITWISE_AND";
    Order[Order["BITWISE_XOR"] = 9] = "BITWISE_XOR";
    Order[Order["BITWISE_OR"] = 10] = "BITWISE_OR";
    Order[Order["RELATIONAL"] = 11] = "RELATIONAL";
    Order[Order["LOGICAL_NOT"] = 12] = "LOGICAL_NOT";
    Order[Order["LOGICAL_AND"] = 13] = "LOGICAL_AND";
    Order[Order["LOGICAL_OR"] = 14] = "LOGICAL_OR";
    Order[Order["CONDITIONAL"] = 15] = "CONDITIONAL";
    Order[Order["LAMBDA"] = 16] = "LAMBDA";
...
export class PythonGenerator extends CodeGenerator {
     ...
     */
    getAdjustedInt(block, atId, delta = 0, negate = false) {
