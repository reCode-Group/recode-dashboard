...
export function lists_setIndex(block, generator) {
    ...
    function cacheList() {
        ...
        const listVar = generator.nameDB_.getDistinctName('tmpList', NameType.VARIABLE);
    ...
    switch (where) {
        ...
        case 'RANDOM': {
            let code = cacheList();
            const xVar = generator.nameDB_.getDistinctName('tmpX', NameType.VARIABLE);
            code +=
...
export function lists_getSublist(block, generator) {
    ...
    if (where1 === 'FIRST' && where2 === 'LAST') {
        ...
        const functionName = generator.provideFunction_('subsequence' + wherePascalCase[where1] + wherePascalCase[where2], `
...
export function lists_sort(block, generator) {
    ...
    const getCompareFunctionName = generator.provideFunction_('listsGetSortCompare', `
