...
export class Options {
    ...
    constructor(options) {
        ...
        if (!readOnly) {
            toolboxJsonDef = toolbox.convertToolboxDefToJson(options['toolbox'] ?? null);
     ...
     */
    static parseMoveOptions(options, hasCategories) {
     ...
     */
    static parseZoomOptions(options) {
     ...
     */
    static parseGridOptions(options) {
     ...
     */
    static parseThemeOptions(options) {
