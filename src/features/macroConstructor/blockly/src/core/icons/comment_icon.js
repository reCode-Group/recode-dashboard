...
export class CommentIcon extends Icon {
    ...
    applyColour() {
        super.applyColour();
        const colour = this.sourceBlock.getColour();
    ...
    setText(text) {
        ...
        eventUtils.fire(new (eventUtils.get(EventType.BLOCK_CHANGE))(this.sourceBlock, 'comment', null, oldText, text));
        this.text = text;
    ...
    onTextChange() {
        ...
        if (this.text === newText)
            return;
        eventUtils.fire(new (eventUtils.get(EventType.BLOCK_CHANGE))(this.sourceBlock, 'comment', null, this.text, newText));
        this.text = newText;
    }
    /**
    ...
    async setBubbleVisible(visible) {
        ...
        eventUtils.fire(new (eventUtils.get(EventType.BUBBLE_OPEN))(this.sourceBlock, visible, 'comment'));
    }
