...
export class FlyoutNavigator extends Navigator {
    constructor(flyout) {
        super();
        this.rules.push(new FlyoutButtonNavigationPolicy(), new FlyoutSeparatorNavigationPolicy());
        this.rules = this.rules.map((rule) => new FlyoutNavigationPolicy(rule, flyout));
    }
}
//# sourceMappingURL=flyout_navigator.js.map