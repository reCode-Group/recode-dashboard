...
export class ConnectionDB {
     ...
     *     found.
     */
    findIndexOfConnection(conn, yPos) {
    ...
    getNeighbours(connection, maxRadius) {
         ...
         */
        function checkConnection(yIndex) {
     ...
     */
    isInYRange(index, baseY, maxRadius) {
...
//# sourceMappingURL=connection_db.js.map