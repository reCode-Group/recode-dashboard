 ...
 */
function getSizeInternal(element) {
...
export function getPageOffset(el) {
    ...
    // the viewport.
    const scrollCoord = new Coordinate(window.pageXOffset || documentElement.scrollLeft, window.pageYOffset || documentElement.scrollTop);
 ...
 */
export function getContainerOffsetToScrollInto(element, container, opt_center) {
