...
const workspaceToDragDelta = new WeakMap();
/**
 ...
 */
function mouseToWorkspacePoint(workspace, e) {
    const point = browserEvents.mouseToSvg(e, workspace.getParentSvg(), workspace.getInverseScreenCTM());
 ...
 */
export function start(workspace, e, xy) {
 ...
 */
export function move(workspace, e) {
    const point = mouseToWorkspacePoint(workspace, e);
