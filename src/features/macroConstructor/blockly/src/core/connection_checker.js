...
export class ConnectionChecker {
    ...
    canConnectWithReason(a, b, isDragging, opt_distance) {
        ...
        if (isDragging &&
            !this.doDragChecks(a, b, opt_distance || 0)) {
    ...
    doSafetyChecks(a, b) {
        ...
        else if (inferiorConnection.type !==
...
registry.register(registry.Type.CONNECTION_CHECKER, registry.DEFAULT, ConnectionChecker);
//# sourceMappingURL=connection_checker.js.map