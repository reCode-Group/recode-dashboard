 ...
 */
export class SeparatorFlyoutInflater {
    /**
...
registry.register(registry.Type.FLYOUT_INFLATER, SEPARATOR_TYPE, SeparatorFlyoutInflater);
//# sourceMappingURL=separator_flyout_inflater.js.map