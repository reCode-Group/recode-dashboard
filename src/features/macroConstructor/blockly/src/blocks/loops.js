...
Extensions.register('controls_flow_tooltip', Extensions.buildTooltipForDropdown('FLOW', BREAK_CONTINUE_TOOLTIPS));
/**
...
Extensions.registerMixin('contextMenu_newGetVariableBlock', CUSTOM_CONTEXT_MENU_CREATE_VARIABLES_GET_MIXIN);
Extensions.register('controls_for_tooltip', Extensions.buildTooltipWithFieldText('%{BKY_CONTROLS_FOR_TOOLTIP}', 'VAR'));
Extensions.register('controls_forEach_tooltip', Extensions.buildTooltipWithFieldText('%{BKY_CONTROLS_FOREACH_TOOLTIP}', 'VAR'));
/**
...
const CONTROL_FLOW_IN_LOOP_CHECK_MIXIN = {
    ...
    onchange: function (e) {
        ...
        this.setWarningText(enabled ? null : Msg['CONTROLS_FLOW_STATEMENTS_WARNING']);
        if (!this.isInFlyout) {
            try {
                ...
                this.setDisabledReason(!enabled, CONTROL_FLOW_NOT_IN_LOOP_DISABLED_REASON);
            }
            finally {
