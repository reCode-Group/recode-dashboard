...
function SignUp() {
  ...
  const handleAccountSubmit = async (event) => {
    ...
    try {
      ...
      setStep("verify");
      setNotice("Код подтверждения отправлен на вашу почту");
    } catch (requestError) {
      ...
      <Flex alignItems="center" justifyContent="center" mb="60px" mt="20px">
        ...
        >
          ...
          {step === "account" ? (
            ...
            <>
              <Text color={secondTextColor} fontSize="sm" mb="18px" textAlign="center">
                Введите код, отправленный на {normalizedEmail}
              </Text>
              <FormControl isRequired>
                <FormLabel ms="4px" fontSize="sm" fontWeight="normal">
                  Код подтверждения
          ...
          <Flex flexDirection="column" justifyContent="center" alignItems="center" maxW="100%" mt="0px">
            <Text color={secondTextColor} fontWeight="regular">
              Уже есть аккаунт?
              <Link as={RouterLink} to="/auth/login-page" color={titleColor} ms="5px" fontWeight="bold">
                Войти
              </Link>
            </Text>
          </Flex>
