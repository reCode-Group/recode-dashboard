			...
			>
				...
				>
					<ModalHeader px={{ base: 6, md: 8 }} pt={{ base: 7, md: 8 }} pb={3}>
						...
						>
							{isError
								...
								: 'Конструктор доступен на расширенных пакетных тарифах'}
						</Heading>
					</ModalHeader>
					<ModalBody px={{ base: 6, md: 8 }} pb={6}>
						<Text color={descriptionColor} fontSize="15px" lineHeight="1.65">
							{isError
								? 'Возникла ошибка при проверке пакета. Попробуйте повторить запрос через несколько секунд.'
								: 'Ваш текущий пакет не включает Конструктор макросов. Выберите подходящий пакет, чтобы создавать и редактировать макросы.'}
						</Text>
					</ModalBody>
					<ModalFooter
						px={{ base: 6, md: 8 }}
					...
					>
						...
						>
							{isError ? 'Повторить' : 'Выбрать пакет'}
						</Button>
					</ModalFooter>
				</ModalContent>
			</Modal>
